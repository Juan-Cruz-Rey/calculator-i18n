---
title: "Calculadora de Grasa Corporal del Ejército Gratis - Método Militar 2026"
...
- **[Calculadora de IMC](../imc/)**: Relación peso/altura; screening inicial simple
- **[Calculadora de Grasa Corporal (Métodos Civiles)](../grasa-corporal/)**: Múltiples métodos (Navy, calipers, etc.)
- **[Calculadora de Masa Corporal Magra](../masa-magra/)**: Estima masa muscular basada en grasa corporal

**Calculadoras de Peso:**
- **[Calculadora de Peso Ideal](../peso-ideal/)**: Múltiples fórmulas (Devine, Robinson, Miller)
- **[Calculadora de Peso Saludable](../peso-saludable/)**: Rango de peso basado en altura y complexión

**Calculadoras Metabólicas:**
- **[Calculadora de TMB](../tmb/)**: Tasa metabólica basal (calorías en reposo)
- **[Calculadora de TDEE](../gasto-energetico-diario/)**: Gasto energético diario total (incluye actividad)
- **[Calculadora de Calorías para Pérdida de Peso](../deficit-calorico/)**: Determina déficit apropiado

**Calculadoras de Macronutrientes:**
- **[Calculadora de Proteína](../proteina/)**: Requerimientos de proteína para objetivos específicos
- **[Calculadora de Macros](../macros/)**: Distribución completa de proteína/carbohidratos/grasas

**Calculadoras de Fitness:**
- **[Calculadora de 1RM](../1rm/)**: Máximo de una repetición para levantamiento de pesas
- **[Calculadora de Volumen de Entrenamiento](../volumen/)**: Optimiza series y repeticiones
