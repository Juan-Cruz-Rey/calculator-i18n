---
title: "Calculateur Rapport Taille-Hanches Gratuit - RTH 2026"
...
- **[Calculateur IMC (Indice de Masse Corporelle)](../imc/)** - Évaluez votre poids par rapport à votre taille
- **[Calculateur Pourcentage de Graisse Corporelle](../graisse-corporelle/)** - Estimez votre composition corporelle
- **[Calculateur Poids Idéal](../poids-ideal/)** - Découvrez votre poids optimal pour la santé
- **[Calculateur Poids Santé](../poids-sante/)** - Déterminez votre plage de poids saine
- **[Calculateur BSA (Surface Corporelle)](../surface-corporelle/)** - Calculez votre surface corporelle pour applications médicales
- **[Calculateur TMB (Taux Métabolique de Base)](../mb/)** - Estimez vos besoins caloriques au repos
- **[Calculateur TDEE (Dépense Énergétique Totale)](../depense-energetique-quotidienne/)** - Calculez vos besoins caloriques quotidiens totaux
- **[Calculateur Macronutriments](../macros/)** - Optimisez votre répartition protéines/glucides/lipides
- **[Calculateur Protéines](../proteines/)** - Déterminez vos besoins quotidiens en protéines
- **[Calculateur Calories](../calories/)** - Planifiez votre apport calorique pour vos objectifs
