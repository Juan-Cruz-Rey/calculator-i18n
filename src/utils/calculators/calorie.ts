 ...
 * Calculates daily calorie needs based on age, gender, height, weight, and activity level
 */
...
export interface CalorieResult {
  ...
  maintenance: number; // Calories to maintain weight
...
/**
 * Main function to calculate daily calorie needs
 */
export function calculateCalories(input: CalorieInput): CalorieResult {
  ...
  return {
    ...
    mildWeightLoss: Math.round(maintenance - 275),
    weightLoss: Math.round(maintenance - 550),
    extremeWeightLoss: Math.round(maintenance - 1100),
    mildWeightGain: Math.round(maintenance + 275),
    weightGain: Math.round(maintenance + 550),
    extremeWeightGain: Math.round(maintenance + 1100),
    formula,
  };
}
